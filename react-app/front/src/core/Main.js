...
export default function Main() {
    ...
    return (
        ...
        <br/>
        <br/>
        <CreateBlog renderBlogs={renderBlogs} setRenderBlogs={setRenderBlogs} className='text-center' />
        ...
        {blogs.map(blog =>
           <Blog
            ...
            renderLikes={renderLikes}  setRenderLikes={setRenderLikes} setBlogs={setBlogs}
