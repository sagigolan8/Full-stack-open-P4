  ...
  return (
    <div>
      <div style={hideWhenVisible}>
        <button className='btn btn-success' onClick={toggleVisibility}><b>Create new blog</b></button>
      </div>
      <div style={showWhenVisible}>
        <div>
          ...
          <br/>
          <br/>
          <button className='btn btn-primary' onClick={()=>CreateBlog()}>Create New Blog</button>
          <br/>
          <br/>
        </div>
        <button className='btn btn-danger' ref={cancelRef} onClick={toggleVisibility}><b>Cancel</b></button>
      </div>
    </div>
  )
}
